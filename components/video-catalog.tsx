...
export function VideoCatalogSelector() {
  ...
  // Mock data to demonstrate state change
  const recentVideos = [
    { id: 1, name: "Forehand Drill - Sept 12" },
    { id: 2, name: "Match vs. Anderson" },
    { id: 3, name: "Serve Practice Session" },
  ]
  ...
  return (
    // FIX 1: Use flex-col and h-full on parent to enable flex growth for children
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <span 
                className={cn(
                  "text-lg font-medium",
                  currentVideo ? "text-foreground" : "text-muted-foreground italic"
                )}
              >
                {currentVideo || "None"}
              </span>
          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-border px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-foreground">Video Catalog</h2>
                  <p className="text-sm text-muted-foreground">Select a video to view analysis</p>
                </div>
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {recentVideos.map((video) => (
                  <button
                    ...
                    className="flex flex-col items-start gap-3 rounded-xl border border-border bg-card p-4 text-left transition-all hover:border-primary/50 hover:shadow-md"
                  >
                ...
                <div className="col-span-full mt-8 flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-border py-12 text-center">
                  <p className="text-sm font-medium text-muted-foreground">More content coming soon...</p>
                </div>
              </div>
            </div>
...
export default function App() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-background p-8">
      <div className="w-full max-w-md h-[600px]"> {/* Fixed height to demonstrate flex-1 behavior */}
